...
class SocialNetworkDeserializer extends Deserializer[SocialNetwork] {

  override def configure(configs: util.Map[String, _], isKey: Boolean): Unit = {}

  override def deserialize(topic: String, data: Array[Byte]): SocialNetwork = {
    val reader = new SpecificDatumReader[SocialNetwork](SocialNetwork.SCHEMA$)
    ...
    val outVersion = new SocialNetwork()
